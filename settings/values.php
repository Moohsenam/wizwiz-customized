...
$mainValues = [
    'banned' => 'متاسفانه شما از ناگت وی پی ان بن شدید!',
    'customer_custome_plan_day' => "زمان مورد نیاز برای اشتراکتون رو به مقدار روز وارد کنید\n💰|هزینه هر روز: DAY-PRICE",
    'customer_custome_plan_volume'=>"حجم مورد نیازتون رو به گیگابایت وارد کنید\n💰|هزینه هر گیگ: VOLUME-PRICE",
    'customer_custome_plan_name'=>'اسم کانفیگتون رو تایین کنید( حروف انگیلیسی و عدد باهم وارد کنید )',
    'send_user_id'=>" آیدی عددی کاربر رو بفرست :",
    'enter_decrease_amount'=>"مبلغ مورد نیاز برای کاهش رو وارد کنید:",
    'enter_increase_amount'=>"مبلغ مورد نیاز برای ارسال رو وارد کنید:",
    'user_not_found'=>"انگار آیدی رو اشتباه وارد کردین :(",
    ...
    'increase_wallet_cart_to_cart'=>"لطفا فیش واریز رو ارسال کنید

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

از 8 صبح تا 12 شب نهایتا تا 5 دقیقه بعد ارسال فیش تایید میشه 🟢",
    'order_increase_sent'=>" سفارش شما با موفقیت ثبت شد.
   خیلی زود مبلغ تایید و به حسابتون اضافه میشه🧡",
    'please_send_only_image'=>"لطفا فقط عکس ارسال کنید",
    'reached_main_menu'=>"برگشیتم منوی اصلی
...
",
    ...
    'buy_account_cart_to_cart'=>"لطفا فیش واریز رو ارسال کنید

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

از 8 صبح تا 12 شب نهایتا تا 5 دقیقه بعد ارسال فیش تایید میشه 🟢

بعد از تایید پرداخت بصورت خودکار سرویستون همینجا فرستاده میشه!",
    'renew_ccount_cart_to_cart'=>"لطفا فیش واریز رو ارسال کنید
...
",
    ...
    'select_one_to_show_detail'=> ' یکی از سرویس ها رو انتخاب کنید:',
    'you_dont_have_config'=>'شما هیچ سرویسی ندارید🙁,
...
",
    ...
    'start_message'=>'به ناگت وی پی ان خوش اومدی🧡
    
    اینجا میتونی با قیمت مناسب از دردسر سرعت پایین و قطعی زیاد خلاص شی!,
...
به نظرم یه پیام براش بفرست مثلا ( تبلیغی یا خوش آمد گویی ) 😍",
    "not_joine_yet"=>"هنوز که عضو چنل نشدی",
    'insert_discount_code'=>"کد تخفیف رو وارد کن:",
    "not_valid_discount_code"=>"😔کد تخفیف معتبر نیست",
    'valid_discount_code'=>"✅کد تخفیف با موفقیت ثبت شد
...
⁮⁮ ⁮⁮",
    ...
    'agency_request_declined'=>"درخواست شما برای نمایندگی تایید نشدد",
...
دسته بندی مورد نظر رو انتخاب کنیذ ",
...
لطفا یکی از پلن های موجود رو انتخاب کنید", 
    'buy_custom_plan'=>'خرید پلن کاستوم',
    'select_one_plan_to_edit'=>"یکی از پلن های موجود رو برای ویرایش انتخاب کنید", 
    'enter_account_amount' => "تعداد اکانت مورد نیازتون رو وارد کنید
